...
<div>
    If you would like to pay by check:  Make it payable to Time to Blossom and mail to
<blockquote>Time to Blossom 2251 N. 32nd St. #17 <br /> Mesa Az. 85213 </blockquote>
    If you would like to pay by credit card or paypal hit this button
</div>
   <!-- <a href="http://www.timetoblossom.com/pages/pay.htm">Redirecting to PayPal</a>-->
    <form id = 'f' style = '' action="https://www.paypal.com/cgi-bin/webscr" method="post">
    ...
    <script>
        //uncomment if you want to automatically submit
...
<body>
    ...
    <div>
        If you would like to pay by check:  Make it payable to Time to Blossom and mail to
        <blockquote>Time to Blossom <br /> 2251 N. 32nd St. #17 <br /> Mesa Az. 85213 </blockquote>
        If you would like to pay by credit card or paypal hit this button
    </div>
    <!--<a href="http://www.timetoblossom.com/pages/pay.htm">Redirecting to PayPal</a>-->
    <form style = "" id = 'f' action="https://www.paypal.com/cgi-bin/webscr" method="post">
    <input type="hidden" name="cmd" value="_s-xclick">
